...
namespace Astmara6.Classes
{
   public static class  Print
    {
        public static void data2ExelIstmaraA(UserControl v, DataGrid dataGrid, List<SubjectTeacher> subjectTeachers, string semester, string year)
        {
        ...
        public static void data2ExelIstmaraBD(UserControl v, DataGrid dataGrid, List<StudentStatment> studentStatments, string semester, string year)
        {
